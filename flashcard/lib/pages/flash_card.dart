...
//         _currentIndex++;
//         if (_currentIndex >= _words.length) {
//           _cardPosition = Offset(size.width * 2,
//               _cardPosition.dy); // Di chuyển thẻ ra khỏi màn hình nếu hết thẻ
...
//                     : Offset(-size.width * 2, _cardPosition.dy);
//               });
//               _handlePanEnd(MediaQuery.of(context)
//                   .size); // Truyền kích thước màn hình vào _handlePanEnd()
//               if (_cardPosition.dx != 0) {
...
//                       horizontal: 16), // Khoảng cách giữa Card và Progress Bar
//                   decoration: BoxDecoration(
//                     borderRadius:
//                         BorderRadius.circular(15), // Bo góc của Container
//                   ),
//                   child: Column(
...
//                                 ? (__isEnglishFirst
//                                     ? _buildFrontWidget(_words.isNotEmpty
//                                         ? _words[_currentIndex].english
//                                         : "")
//                                     : _buildBackWidget(_words.isNotEmpty
//                                         ? _words[_currentIndex].vietnam
//                                         : ""))
//                                 : (__isEnglishFirst
//                                     ? _buildBackWidget(_words.isNotEmpty
//                                         ? _words[_currentIndex].vietnam
...
//                                         ? _words[_currentIndex].vietnam
//                                         : "")),
//                             direction: FlipDirections.horizontal,
//                             onAnimationStart: () {
//                               setState(() {
//                                 _isAnimating = true;
//                               });
...
//                       ),
//                       const SizedBox(
//                           height: 20), // Khoảng cách giữa Card và Progress Bar
...
//                           child:
//                               Text(_isAutoMode ? 'Manual Mode' : 'Auto Mode'),
//                         ),
//                       ),
//                     ],
//                   ),
...
//                               percentageCorrect:
//                                   calculatePercentage(right, wrong, _words),
//                               correctCount: right.length,
//                               wrongCount: wrong.length,
//                               elapsedTime:
//                                   _formatElapsedTime(_finalElapsedSeconds),
//                               typeTest: "FlashCard");
//                         }
